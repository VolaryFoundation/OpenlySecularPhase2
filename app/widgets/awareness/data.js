...
hub.on('faqNeeded', function() {
  hub.trigger('faqLoaded', [
    ...
    { question: 'What if I have other questions not answered above?', answer: 'We are happy to answer other questions you may have. Please reach out to us via the contact information above, or <a href="#/contact">click here</a>.' }
  ])
})
